...
void CTakeOwnerShipDlg::OnBnClickedDel()
{
	...
	MessageBox(_T("删除成功"),_T("提示"), MB_OK | MB_ICONINFORMATION);
	}
	else MessageBox(_T("未检测到右键管理员权限菜单！"),_T("提示"),MB_OK | MB_ICONSTOP);
}
